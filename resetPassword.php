...
<body>
    <div class="container">
        ...
        <form action="authUser.php" method="post">
            <input type="text" name="login" value = 'resetpassword' style="display: none;">
            <input type="email" name="email" value="<?php session_start(); if(!empty($_SESSION["email"])){ echo $_SESSION["email"]; } ?>" placeholder="Email" required>
